...
JsCtl = (function(superClass) {
  ...
  JsCtl.prototype.combOneMod = function(name, cb) {
    var _cb, _content, _curFile, _curHash, _curKey, _jsData, _jsFile, _jsHash, _jsMap, _jsSource, _modDeps, _modName, _name, _outName, _source, _tempHash, _this, error, f, i, len;
    _this = this;
    _cb = cb || function() {};
    _modName = name;
        ...
        return _this.coreModule(function() {
          return _this.combAllMods(function() {
            return _this.combNormalJs(function() {
              Utils.saveMapFile('jsHash');
              Utils.saveMapFile('jsMap');
              return _cb();
            });
          });
        });
