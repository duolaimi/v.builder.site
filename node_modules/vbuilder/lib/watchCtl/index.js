 ...
 * @version $Id$
 */
var CssCtl, FontsCtl, HtmlCtl, ImgCtl, JSHINT, JsCtl, SpCtl, Tools, TplCtl, Utils, Watch, color, cssCtl, fontsCtl, fs, gutil, htmlCtl, imgCtl, jsCtl, jshint, opts, path, spCtl, tplCtl, watcher, _,
...
watcher = function(cb) {
  ...
  _this = this;
  _list = [];
  _files = ["" + opts.srcPath + "/less/**/*.less", "" + opts.srcPath + "/sprite/**/*.png", "" + opts.srcPath + "/html/**/*.html", "" + opts.srcPath + "/js/**/*.js", "" + opts.srcPath + "/tpl/**/*.html", "" + opts.srcPath + "/img/*.{gif,jpg,png,svg}", "" + opts.srcPath + "/img/**/*.{gif,jpg,png,svg}", "!.DS_Store"];
  _filePaths = [];
  ...
  return Watch(_files, function(file) {
    var err, watch_timer, _event, _filePath, _type;
    try {
      _event = file.event;
      if (_event !== "undefined") {
        _filePath = file.path.replace(/\\/g, "/");
        if (__indexOf.call(_list, _filePath) < 0) {
